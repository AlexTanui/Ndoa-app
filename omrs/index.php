...
<body>
	<div class="w3ls-icons">
		...
		<li><a href="admin/login.php" style="color: #fff;"><button id="Admin_btn" style="background-color: blue; color: white;">Admin</button></a></li>

			
		<li style="padding-left: 20px"><a href="user/login.php" style="color: #fff;"> <button id="User_btn" style="background-color: green; color: white;">User</button></a>
</li>
...
<div class="w3ls-content">
	<div class="w3ls-headding">
		...
		<p>We are launching the most awesome site ever in kenya. It's gonna be legendary</p>
	</div>
	
</div>

<footer>&copy; 2023 Online Marriage Registration System</footer>
</body>
</html>