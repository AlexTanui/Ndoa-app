      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>Hello there,</h2>
              <p>Thank you for choosing to sign up with us! </p>
              <p>We're excited to have you on board. Please fill out the form below with your information, and we'll create your account in no time. If you have any questions or need assistance, our team is here to help. Welcome to our community!</p>
...
<div class="form-group">
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Copyright &copy; 2023. All Rights Reserved. Jackline Wanjiku</p>
      </div><!-- signin-box -->
